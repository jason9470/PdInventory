...
達到 10（含）時顯示提醒，送出時若系統類別不是「核心系統」則跳出阻擋視窗並提供一鍵修正。

> 現有資料中 SW-029、082、083、084、114、135 這 6 筆的資產價值正好是 10 但屬於「一般系統」，
> 因此在畫面上無法儲存，直到有人把類別改成核心系統為止。這 6 筆不在 1150402 核心系統
> 確認會議的名單中，是否要一併改列核心系統尚未決定。
>
